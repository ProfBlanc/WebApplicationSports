...
namespace WebApplicationSports.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Purchases.Include(p => p.IdentityUser).Include(p => p.Seat);
        ...
        public async Task<IActionResult> Create([Bind("PurchaseId,SeatId,UserId,PaymentMethod")] Purchase purchase)
        {
            ...
            ViewData["SeatId"] = new SelectList(_context.Seats, "SeatId", "SeatId", purchase.SeatId);
            return View(purchase);
        }
